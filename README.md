...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cruft-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10583&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cruft-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cruft` can be installed with:

```
conda install cruft
```

It is possible to list all of the versions of `cruft` available on your platform with:
